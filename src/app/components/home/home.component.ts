...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seo.title = 'Gomez Adorable Puppies | puppies available online.'
    this.seo.description =
      'healthy and lovely Gomez puppies online at very affordable prices and enjoy veterinary services to keep your pets healthy always.'
    this.tags = [
      {
        name: 'twitter:title',
        content: 'Gomez Adorable Puppies | puppies available online.',
      } as MetaTag,
      {
        name: 'twitter:description',
        content:
          'Shelter healthy and lovely puppies online at very affordable prices and enjoy veterinary services to keep your pets healthy always.',
      } as MetaTag,
      {
        name: 'twitter:image',
        content:
      ...
      {
        name: 'twitter:label1',
        content: 'Gomez Adorable Puppies',
      } as MetaTag,
      {
        name: 'twitter:data1',
      ...
      {
        name: 'twitter:card',
        content: 'Lovely Puppies',
      } as MetaTag,
      {
        name: 'twitter:creator',
        content: '@gomezadorablepuppies',
      } as MetaTag,
    ]
  ...
  submit() {
    ...
    this.apiService.contact(this.contact).subscribe(
      (data: any) => {
        this.isLoading = true
        Swal({
          title: 'Thanks!',
      ...
      (err: HttpErrorResponse) => {
        ...
        Swal({
          title: 'Error!',
          text:
            'Unable to send message. Make sure you are connected to the internet',
          type: 'warning',
