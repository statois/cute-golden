...
export const PETS: Pet[] = [
...

  {
    id: 'yorkie-flore',
    name: 'FLORE',
    image: 'assets/img/golden-retriever/puppies/backup/flore.jpeg',
...

  {
    id: 'frenchie-susan',
    name: 'SUSAN',
    image: 'assets/img/golden-retriever/puppies/backup/susan.jpeg',
    cartImage: 'assets/img/cartImage/adopt.jpg',
    gender: 'Female',
    age: '9 weeks',
    vaccinated: 'yes',
...

  {
    id: 'pitbull-romeo',
    name: 'ROMEO',
    image: 'assets/img/golden-retriever/puppies/backup/romeo.jpeg',
    cartImage: 'assets/img/cartImage/adopt.jpg',
    gender: 'Male',
    age: '8 weeks',
    vaccinated: 'yes',
  ...
  //   gender: 'Female', age: "8 weeks", vaccinated: 'yes', size: 'small', price: 1800,
  ...
  //   gender: 'Female', age: "15 weeks", vaccinated: 'yes', size: 'medium', price: 1500,
  //   petCategory: "Golden Retriever",
  //   registered: "AKC Registered",
  //   status: true,
